 ...
 * -----which I'm not using because I sort with JavaScript on the page instead
 * ****************************************************************************
 ...
 */	 
	  ...
	  *
	  *	@param $a an element in $array -- usort handles indexing
	  * @param $b an element in $array -- usort handles indexing
	  * 
	  * @return -1, 0, or 1 -- for use by usort
	  *
	  */
